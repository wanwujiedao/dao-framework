 ...
 * @author 阿导
 * @CopyRight 万物皆导
 * @Created 2019-08-29 15:14:00
 */
@Order(Ordered.HIGHEST_PRECEDENCE)
@ConfigurationProperties(prefix = "dao.druid")
public class DaoDruidProperties {


    // defaultAutoCommit,maxOpenPreparedStatements,logAbandoned,removeAbandonedTimeout,removeAbandoned
